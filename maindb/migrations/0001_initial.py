    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentcode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='maindb.budget', verbose_name='Вышестоящий бюджет')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateinclusion', models.DateTimeField(default=datetime.datetime.now, verbose_name='Дата включения кода')),
                ('dateexclusion', models.DateTimeField(verbose_name='Дата исключения кода')),
                ('year', models.DateField(verbose_name='Год')),
                ('budget', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='maindb.budget', verbose_name='Бюджет')),
            ],
            options={
